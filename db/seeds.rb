...
file2 = URI.open("https://cdn.motor1.com/images/mgl/6ZAvXk/s1/lamborghini-invencible.jpg")
car = Car.new(brand: 'Porscheeeee', model: 'Taycan', price_per_day: 234,
...
car.photos.attach(io: file, filename: "porsche.png", content_type: "image/png")
car.photos.attach(io: file2, filename: "porsche44.png", content_type: "image/png")
car.save!
...
car.photos.attach(io: file, filename: "lambo.jpg", content_type: "image/jpg")
car.save!
...
car.photos.attach(io: file, filename: "porsche2.jpg", content_type: "image/jpg")
car.save!
